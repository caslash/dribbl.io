...
struct PlayerAwardTests {
    ...
    init() throws {
        ...
        guard let playerAwardsUrl = Bundle.module.url(forResource: "playerawards", withExtension: "json") else {
            fatalError("playerawards.json not found in test bundle.")
        }
        self.playerAwardsUrl = playerAwardsUrl

        guard let playerAwardsListUrl = Bundle.module.url(forResource: "playerawardslist", withExtension: "json") else {
            fatalError("playerawardslist.json not found in test bundle.")
        }
        self.playerAwardsListUrl = playerAwardsListUrl
