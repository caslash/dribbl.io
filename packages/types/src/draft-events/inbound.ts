...
export type SaveDraftConfigEvent = {
  ...
  /** Pool is generated by the gateway and injected before forwarding to the machine. */
  pool: PoolEntry[];
};
...
export type SubmitPickEvent = {
  type: 'SUBMIT_PICK';
  /** Client sends participantId, entryId, round. pickNumber is computed by the machine. */
  pickRecord: {
    participantId: string;
    entryId: string;
    round: number;
