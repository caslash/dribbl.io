...
struct PlayerProfileV2Tests {
    ...
    init() throws {
        ...
        guard let playerProfileUrl = Bundle.module.url(forResource: "playerprofilev2", withExtension: "json") else {
            fatalError("playerprofilev2.json not found in test bundle.")
        }

        self.url = playerProfileUrl
