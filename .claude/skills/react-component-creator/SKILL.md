...
## Step 6: Hand off to the reat-unit-test-engineer agent

Once all files are written, you **must** invoke the ` reat-unit-test-engineer` agent — don't skip this step or leave it as a suggestion. Use the Agent tool directly:

```
subagent_type:  reat-unit-test-engineer
